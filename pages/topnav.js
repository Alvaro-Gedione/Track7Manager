...
class TopNavigation extends HTMLElement {
            ...
            <header style="background-color: ${headerBg};
                ...
                <div class="logo-area" style="display: flex; align-items: center; gap: 20px;">
                    <div style="display: flex; align-items: center;">
                        <img src="../public/logo_track7.png" alt="Track7" style="height: 100px; width: auto; object-fit: contain;">
                    </div>
                    ...
                    <nav>
                        <ul style="list-style: none; display: flex; gap: 5px; margin: 0; padding: 0;">
                            <li class="nav-item" style="position: relative; padding: 12px 18px; cursor: pointer; border-radius: 6px; transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); color: #9e9e9e; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                                Monitorar <i class="fas fa-chevron-down" style="font-size: 10px; margin-left: 5px;"></i>
                                <div class="dropdown-content" style="position: absolute; top: 100%; left: 0; background: #1e1e1e; border-top: 3px solid #f264220a; border-radius: 0 0 12px 12px; min-width: 220px; box-shadow: 0 15px 35px rgba(0, 0, 0, 0.8); opacity: 0; visibility: hidden; transform: translateY(15px); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); padding: 10px 0;">
                                    <a href="live-tracking.html" style="padding: 12px 20px; display: flex; align-items: center; gap: 12px; color: #a0a0a0; text-decoration: none; font-size: 13px; transition: 0.2s;"><i class="fas fa-satellite"></i> Mapa em Tempo Real</a>
                                    <a href="#" style="padding: 12px 20px; display: flex; align-items: center; gap: 12px; color: #a0a0a0; text-decoration: none; font-size: 13px; transition: 0.2s;"><i class="fas fa-exclamation-triangle"></i> Alertas Críticos</a>
                                    <a href="#" style="padding: 12px 20px; display: flex; align-items: center; gap: 12px; color: #a0a0a0; text-decoration: none; font-size: 13px; transition: 0.2s;"><i class="fas fa-broadcast-tower"></i> Status dos Sensores</a>
                                </div>
                            </li>
                        </ul>
                    </nav>
                ...
                <div class="user-info">
                    <div class="user-badge" style="display: flex; align-items: center; gap: 12px; background: rgba(255, 255, 255, 0.03); padding: 8px 16px; border-radius: 30px; border: 1px solid rgba(255, 255, 255, 0.08);">
                        ...
                        <a href="index.html" class="home-btn" style="text-decoration: none; color: #9e9e9e; font-size: 18px; transition: all 0.3s ease; display: flex; align-items: center; margin-right: 5px;">
                        ...
                        <img src="https://i.pravatar.cc/100?u=alvaro" alt="User" style="width: 32px; height: 32px; border-radius: 50%; border: 2px solid #f26522;">
                    </div>
                </div>
            </header>
        `;
    ...
    addHoverStyles() {
        ...
        style.textContent = `
            .nav-item:hover { color: #f26522 !important; background: rgba(255, 255, 255, 0.03) !important; }
            .nav-item:hover .dropdown-content { opacity: 1 !important; visibility: visible !important; transform: translateY(0) !important; }
            .dropdown-content a:hover { background: rgba(242, 101, 34, 0.1) !important; color: #f26522 !important; padding-left: 25px !important; }
            .home-btn:hover { color: #f26522 !important; transform: scale(1.15); }
        `;
